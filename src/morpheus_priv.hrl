...
-define(SHTABLE_INC(Table, Key, Value), '__table_inc'(Table, Key, Value)).
...
-compile({inline, ['__table_set'/3, '__table_inc'/3, '__table_remove'/2, '__table_get'/2, '__table_fold'/3]}).
-compile({nowarn_unused_function, ['__table_set'/3, '__table_inc'/3, '__table_remove'/2, '__table_get'/2, '__table_fold'/3]}).

'__table_set'(T, K, V) -> ets:insert(T, {K, V}), T.
'__table_inc'(T, K, V) -> {T, ets:update_counter(T, K, V)}.
